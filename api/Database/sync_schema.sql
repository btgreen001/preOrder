...
-- Purpose: Bring localhost appdb up to match AppDbContext.
--          All statements use IF NOT EXISTS guards so this
--          script is safe to re-run on any partial state.
-- ============================================================
-- NOTE: The legacy PascalCase tables ("Order", "Organization")
--       created by InitialCreate/SqliteSchemaFix are left
--       untouched. AppDbContext maps to snake_case tables which
--       are created below.
-- ============================================================
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_organization_primary_email
    ON organization(primary_email);
CREATE UNIQUE INDEX IF NOT EXISTS ix_organization_registration_token
    ON organization(registration_token);
CREATE INDEX IF NOT EXISTS organization__parent_organization_id__IX
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_systemuser_emailaddress ON app_user(email_address);
CREATE UNIQUE INDEX IF NOT EXISTS ix_systemuser_username     ON app_user(user_name);
CREATE INDEX        IF NOT EXISTS ix_systemuser_organizationid ON app_user(organization_id);


-- ─────────────────────────────────────────────
-- 3. LICENSE_SUBSCRIPTION
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS license_subscription (
...
CREATE INDEX IF NOT EXISTS ix_licensesubscription_organizationid ON license_subscription(organization_id);
CREATE INDEX IF NOT EXISTS ix_licensesubscription_isactive       ON license_subscription(is_active);
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_registrationcode_registrationcode
    ON registration_code(registration_code);
CREATE INDEX IF NOT EXISTS ix_registrationcode_organizationid
...
CREATE UNIQUE INDEX IF NOT EXISTS ix_usersession_sessiontoken ON user_session(session_token);
CREATE INDEX        IF NOT EXISTS ix_usersession_userid       ON user_session(user_id);
...
CREATE INDEX        IF NOT EXISTS customer__organization_id__IX ON customer(organization_id);
...
CREATE INDEX        IF NOT EXISTS supplier__organization_id__IX ON supplier(organization_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS item_category__external_id__UIX    ON item_category(external_id);
CREATE INDEX        IF NOT EXISTS item_category__organization_id__IX ON item_category(organization_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS product_category__external_id__UIX    ON product_category(external_id);
CREATE INDEX        IF NOT EXISTS product_category__organization_id__IX ON product_category(organization_id);


-- ─────────────────────────────────────────────
-- 11. SELLABLE_PRODUCT
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS sellable_product (
    id                       BIGINT GENERATED BY DEFAULT AS IDENTITY,
    external_id              UUID NOT NULL DEFAULT gen_random_uuid(),
    organization_id          UUID NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS sellable_product__sku__UIX            ON sellable_product(sku) WHERE sku IS NOT NULL;
CREATE INDEX        IF NOT EXISTS sellable_product__organization_id__IX ON sellable_product(organization_id);
...
CREATE INDEX        IF NOT EXISTS inventory_item__organization_id__IX    ON inventory_item(organization_id);
CREATE INDEX        IF NOT EXISTS inventory_item__reorder_point__IX      ON inventory_item(reorder_point);
CREATE INDEX        IF NOT EXISTS inventory_item__expiration_date__IX    ON inventory_item(expiration_date);
...
CREATE UNIQUE INDEX IF NOT EXISTS inventory_lot__external_id__UIX       ON inventory_lot(external_id);
CREATE INDEX        IF NOT EXISTS inventory_lot__organization_id__IX    ON inventory_lot(organization_id);
CREATE INDEX        IF NOT EXISTS inventory_lot__inventory_item_id__IX  ON inventory_lot(inventory_item_id);
...
CREATE INDEX        IF NOT EXISTS inventory_movement__organization_id__IX   ON inventory_movement(organization_id);
CREATE INDEX        IF NOT EXISTS inventory_movement__inventory_item_id__IX ON inventory_movement(inventory_item_id);


-- ─────────────────────────────────────────────
-- 15. PREORDER_EVENT  (HolidayEvent in C#)
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS preorder_event (
...
CREATE UNIQUE INDEX IF NOT EXISTS preorder_event__external_id__UIX    ON preorder_event(external_id);
CREATE INDEX        IF NOT EXISTS preorder_event__organization_id__IX ON preorder_event(organization_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS menu_item__external_id__UIX                 ON menu_item(external_id);
CREATE INDEX        IF NOT EXISTS menu_item__organization_preorder_event__IX  ON menu_item(organization_id, preorder_event_id);


-- ─────────────────────────────────────────────
-- 17. PICKUP_SLOT
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS pickup_slot (
    id                BIGINT GENERATED ALWAYS AS IDENTITY,
    external_id       UUID NOT NULL DEFAULT gen_random_uuid(),
    organization_id   UUID NOT NULL,
    preorder_event_id BIGINT NOT NULL,
...
CREATE UNIQUE INDEX IF NOT EXISTS pickup_slot__external_id__UIX                ON pickup_slot(external_id);
CREATE INDEX        IF NOT EXISTS pickup_slot__organization_preorder_event__IX ON pickup_slot(organization_id, preorder_event_id);
...
CREATE INDEX        IF NOT EXISTS customer_order__organization_id__IX   ON customer_order(organization_id);
CREATE INDEX        IF NOT EXISTS customer_order__customer_id__IX       ON customer_order(customer_id);
CREATE INDEX        IF NOT EXISTS customer_order__preorder_event_id__IX ON customer_order(preorder_event_id);
CREATE INDEX        IF NOT EXISTS customer_order__status__IX            ON customer_order(order_status);
...
CREATE INDEX        IF NOT EXISTS order_item__order_id__IX      ON order_item(customer_order_id);
CREATE INDEX        IF NOT EXISTS order_item__menu_item_id__IX  ON order_item(product_id);
CREATE INDEX        IF NOT EXISTS order_item__status__IX        ON order_item(order_item_status);
...
CREATE UNIQUE INDEX IF NOT EXISTS pre_order__external_id__UIX                 ON pre_order(external_id);
CREATE INDEX        IF NOT EXISTS pre_order__organization_preorder_event__IX  ON pre_order(organization_id, preorder_event_id);


-- ─────────────────────────────────────────────
-- 21. PRE_ORDER_LINE
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS pre_order_line (
    id           BIGINT GENERATED ALWAYS AS IDENTITY,
    external_id  UUID NOT NULL DEFAULT gen_random_uuid(),
...
CREATE UNIQUE INDEX IF NOT EXISTS pre_order_line__external_id__UIX  ON pre_order_line(external_id);
CREATE INDEX        IF NOT EXISTS pre_order_line__pre_order_id__IX  ON pre_order_line(pre_order_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS recipe_detail__external_id__UIX    ON recipe_detail(external_id);
CREATE INDEX        IF NOT EXISTS recipe_detail__organization_id__IX ON recipe_detail(organization_id);
CREATE INDEX        IF NOT EXISTS recipe_detail__master_id__IX       ON recipe_detail(master_id);
CREATE INDEX        IF NOT EXISTS recipe_detail__approved_by__IX     ON recipe_detail(approved_by);
...
CREATE UNIQUE INDEX IF NOT EXISTS recipe_ingredient__external_id__UIX                  ON recipe_ingredient(external_id);
...
CREATE INDEX        IF NOT EXISTS recipe_ingredient__recipe_component_product_id__IX   ON recipe_ingredient(recipe_component_product_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS recipe_composition__external_id__UIX       ON recipe_composition(external_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS recipe_step__external_id__UIX    ON recipe_step(external_id);
CREATE INDEX        IF NOT EXISTS recipe_step__organization_id__IX ON recipe_step(organization_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS recipe_product__external_id__UIX    ON recipe_product(external_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS finished_goods_batch__external_id__UIX    ON finished_goods_batch(external_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS waste_event__external_id__UIX       ON waste_event(external_id);
...
CREATE UNIQUE INDEX IF NOT EXISTS product_movement__external_id__UIX          ON product_movement(external_id);
CREATE INDEX        IF NOT EXISTS product_movement__organization_id__IX       ON product_movement(organization_id);
CREATE INDEX        IF NOT EXISTS product_movement__sellable_product_id__IX   ON product_movement(sellable_product_id);
CREATE INDEX        IF NOT EXISTS product_movement__batch_id__IX              ON product_movement(finished_goods_batch_id);
CREATE INDEX        IF NOT EXISTS product_movement__inventory_lot_id__IX      ON product_movement(inventory_lot_id);
CREATE INDEX        IF NOT EXISTS product_movement__movement_type__IX         ON product_movement(movement_type);
CREATE INDEX        IF NOT EXISTS product_movement__movement_date__IX         ON product_movement(movement_date);


-- ─────────────────────────────────────────────
-- 30. PRODUCTION_TASK  (no explicit mapping, using snake_case convention)
-- ─────────────────────────────────────────────
...
-- ─────────────────────────────────────────────
-- 31. ADMIN_AUDIT_LOG  (no explicit mapping, using EF convention names)
-- ─────────────────────────────────────────────
...
CREATE INDEX IF NOT EXISTS idx_terminal_device_binding_org_token
    ON terminal_device_binding(organization_id, device_token);
CREATE INDEX IF NOT EXISTS idx_terminal_device_binding_org_terminal_active
...
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS terminal_session_lock (
...
CREATE UNIQUE INDEX IF NOT EXISTS unit_conversion__external_id__UIX
    ON unit_conversion(external_id);
CREATE UNIQUE INDEX IF NOT EXISTS unit_conversion__organization_id_from_unit_to_unit__UIX
    ON unit_conversion(organization_id, from_unit, to_unit);


-- ─────────────────────────────────────────────
-- 37. INGREDIENT_TEMPLATE  (no explicit mapping, using EF convention names)
-- ─────────────────────────────────────────────
CREATE TABLE IF NOT EXISTS "IngredientTemplates" (
...
-- ============================================================
-- MIGRATION HISTORY: Mark all known migrations as applied
-- so EF does not attempt to re-apply them.
-- ============================================================
INSERT INTO "__EFMigrationsHistory" ("MigrationId", "ProductVersion")
VALUES
  ('20251006152228_FixIsEnabledBoolean',                   '8.0.10'),
  ('20251017203000_AddPinAuthenticationFields',            '8.0.10'),
  ('20251019143524_AddOrderInventoryProductsWithVersionControl', '8.0.10'),
  ('20251019163800_AddProductInventoryOrderItemTables',    '8.0.10'),
  ('20251019_UpdateCustomerOrderSchema',                   '8.0.10'),
  ('20251022174500_AddInventoryItemColumns',               '8.0.10'),
  ('20251023125200_RenameSystemUserToAppUser',             '8.0.10'),
  ('20251102141500_AddExternalIdColumns',                  '8.0.10'),
  ('20251102201500_Phase3_1_CreateRecipeAndBatchTables',   '8.0.10'),
  ('20260423194500_NormalizeCustomerOrderPreorderForeignKeyTypes', '8.0.10')
