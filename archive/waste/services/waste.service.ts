...
export class WasteService {
  ...
  getWasteEventById(externalId: string): Observable<WasteEvent> {
    return this.http.get<WasteEvent>(`${window.__env.NG_APP_API_URL}/${externalId}`);
  }
  ...
  getWasteAnalytics(startDate?: Date, endDate?: Date): Observable<WasteAnalytics> {
    ...
    return this.http.get<WasteAnalytics>(`${window.__env.NG_APP_API_URL}/analytics`, { params });
  }
}
