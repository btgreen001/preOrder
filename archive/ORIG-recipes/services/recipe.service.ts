...
export class RecipeService {
  ...
  getRecipeById(externalId: string): Observable<RecipeDetail> {
    return this.http.get<RecipeDetail>(`${window.__env.NG_APP_API_URL}/${externalId}`);
  }
  ...
  createRecipeWithDetails(request: CreateRecipeWithDetailsRequest): Observable<RecipeDetail> {
    return this.http.post<RecipeDetail>(`${window.__env.NG_APP_API_URL}/with-details`, request);
  }
  ...
  getRecipeCost(externalId: string) {
    return this.http.get<{ recipeExternalId: string; totalIngredientCost: number; yieldServingCnt: number; yieldUnit: string; costPerUnit: number }>(`${window.__env.NG_APP_API_URL}/${externalId}/cost`);
  }
  ...
  getRecipeCostBreakdown(externalId: string) {
    return this.http.get(`${window.__env.NG_APP_API_URL}/${externalId}/cost/breakdown`);
  }
  ...
  updateRecipe(externalId: string, request: UpdateRecipeRequest): Observable<RecipeDetail> {
    return this.http.put<RecipeDetail>(`${window.__env.NG_APP_API_URL}/${externalId}`, request);
  }

  updateRecipeWithDetails(request: UpdateRecipeWithDetailsRequest): Observable<RecipeDetail> {
    return this.http.put<RecipeDetail>(`${window.__env.NG_APP_API_URL}/with-details`, request);
  }
  ...
  updateRecipeCost(externalId: string, payload: { costPerUnit?: number | null; costPerUnitIsOverride?: boolean }): Observable<RecipeDetail> {
    return this.http.patch<RecipeDetail>(`${window.__env.NG_APP_API_URL}/${externalId}/cost`, payload);
  }
  ...
  checkProductUsageByRecipes(productExternalId: string): Observable<ProductUsageCheckDto> {
    return this.http.get<ProductUsageCheckDto>(`${window.__env.NG_APP_API_URL}/check-product-usage/${productExternalId}`);
  }
  ...
  getRecipeVersions(externalId: string): Observable<RecipeVersionSummaryDto[]> {
    return this.http.get<RecipeVersionSummaryDto[]>(`${window.__env.NG_APP_API_URL}/${externalId}/versions`);
  }
  ...
  createDraftFromRecipe(recipeExternalIdToClone: string): Observable<RecipeDetail> {
    ...
    return this.http.post<RecipeDetail>(`${window.__env.NG_APP_API_URL}/draft-from-recipe`, request);
  }
  ...
  forkRecipe(recipeExternalIdToClone: string): Observable<RecipeDetail> {
    return this.http.post<RecipeDetail>(`${window.__env.NG_APP_API_URL}/clone`, { recipeExternalIdToClone });
  }
  ...
  addIngredient(recipeExternalId: string, request: AddRecipeIngredientRequest): Observable<RecipeIngredientDto> {
    return this.http.post<RecipeIngredientDto>(
      `${window.__env.NG_APP_API_URL}/${recipeExternalId}/ingredients`,
      request
    );
  }
  ...
  getIngredient(recipeExternalId: string, ingredientExternalId: string): Observable<RecipeIngredientDto> {
    return this.http.get<RecipeIngredientDto>(
      `${window.__env.NG_APP_API_URL}/${recipeExternalId}/ingredients/${ingredientExternalId}`
    );
  }
  ...
  updateIngredient(ingredientExternalId: string, request: UpdateRecipeIngredientRequest): Observable<RecipeIngredientDto> {
    return this.http.put<RecipeIngredientDto>(
      `${window.__env.NG_APP_API_URL}/ingredients/${ingredientExternalId}`,
      request
    );
  }
