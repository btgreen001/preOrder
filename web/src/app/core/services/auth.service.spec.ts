...
describe('AuthService', () => {
  ...
  afterEach(() => {
    httpMock.match(req => req.url === `${window.__env.NG_APP_API_URL}/auth/logout` || req.url === `${window.__env.NG_APP_API_URL}/auth/logout-all`)
  ...
  describe('login', () => {
    it('should login successfully and store tokens in memory', (done) => {
      ...
      const req = httpMock.expectOne(`${window.__env.NG_APP_API_URL}/auth/login`);
  ...
  describe('registerUser', () => {
    ...
    it('should register user successfully', (done) => {
      ...
      const req = httpMock.expectOne(`${window.__env.NG_APP_API_URL}/auth/register-user`);
      expect(req.request.method).toBe('POST');
      req.flush(mockAuthResponse);
    });
  });
  ...
  describe('registerCompany', () => {
    ...
    it('should register company successfully', (done) => {
      ...
      const req = httpMock.expectOne(`${window.__env.NG_APP_API_URL}/auth/register-company`);
  ...
  describe('token refresh', () => {
    ...
    it('should refresh access token successfully', (done) => {
      ...
      const req = httpMock.expectOne(`${window.__env.NG_APP_API_URL}/auth/refresh-token`);
      expect(req.request.method).toBe('POST');
      expect(req.request.body).toEqual({});
      expect(req.request.withCredentials).toBeTrue();
      req.flush(newTokens);
    ...
    it('should prevent concurrent refresh attempts', (done) => {
      ...
      const reqs = httpMock.match(`${window.__env.NG_APP_API_URL}/auth/refresh-token`);
  ...
  describe('token revocation', () => {
    ...
    it('should revoke refresh token successfully', (done) => {
      ...
      const req = httpMock.expectOne(`${window.__env.NG_APP_API_URL}/auth/revoke-token`);
      expect(req.request.method).toBe('POST');
      expect(req.request.body).toEqual({});
      expect(req.request.withCredentials).toBeTrue();
      req.flush({});
  ...
  describe('username availability check', () => {
    it('should check username availability', (done) => {
      ...
      const req = httpMock.expectOne(`${window.__env.NG_APP_API_URL}/auth/check-username/testuser`);
