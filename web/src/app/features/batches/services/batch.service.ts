...
export class BatchService {
  private readonly apiUrl = `${window.__env.NG_APP_API_URL}/batches`;
  ...
  getBatchById(externalId: string): Observable<BatchDetail> {
    return this.http.get<BatchDetail>(`${window.__env.NG_APP_API_URL}/${externalId}`);
  }
  ...
  getExpiringBatches(daysUntilExpiration?: number): Observable<BatchDetail[]> {
    ...
    return this.http.get<BatchDetail[]>(`${window.__env.NG_APP_API_URL}/expiring`, { params });
  }
  ...
  completeBatch(externalId: string): Observable<BatchDetail> {
    return this.http.put<BatchDetail>(`${window.__env.NG_APP_API_URL}/${externalId}/complete`, {});
  }
  ...
  cancelBatch(externalId: string): Observable<BatchDetail> {
    return this.http.put<BatchDetail>(`${window.__env.NG_APP_API_URL}/${externalId}/cancel`, {});
  }
  ...
  getFIFOBatches(productId: string, quantityNeeded: number): Observable<any[]> {
    ...
    return this.http.get<any[]>(`${window.__env.NG_APP_API_URL}/fifo`, { params });
  }
  ...
  rotateBatchesFIFO(productId: string, quantityNeeded: number): Observable<any[]> {
    ...
    return this.http.post<any[]>(`${window.__env.NG_APP_API_URL}/fifo-rotate`, request);
  }
  ...
  getExpirationInfo(batchExternalId: string): Observable<any> {
    return this.http.get<any>(`${window.__env.NG_APP_API_URL}/${batchExternalId}/expiration-info`);
  }
}
